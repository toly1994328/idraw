...
class SVGTestPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    String src1 = """<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
""";
    ...
    src.split('path').forEach((String p ) {
      SVGPathResult pathResult = formPathFromSvgOp(p);
      canvas.drawPath(pathResult.path, paint..color=pathResult.color);
    });
  }
