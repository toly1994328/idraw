...
class PathPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    dashPainter.paint(canvas, helpPath, Paint()..color=Colors.red..style=PaintingStyle.stroke..strokeWidth=1);
    ...
    canvas.drawCircle(Offset(size.width/2,size.height/2),2,Paint()..color=Colors.red);
  }
